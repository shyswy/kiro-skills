...
# For scoped packages
cat node_modules/@org/some-plugin/package.json | grep '"version"'
...
ls node_modules/express/*.d.ts
ls node_modules/@types/node/

# Check main entry point
cat node_modules/express/package.json | grep '"main"\|"exports"'
```
...
node_modules/
  express/
  pino/          # hoisted from express's dependencies
  @org/some-plugin/
```
...
node -e "console.log(JSON.stringify(require('./node_modules/express/package.json').exports, null, 2))"
...
ls node_modules/express/*.d.ts
cat node_modules/express/package.json | grep '"types"\|"typings"'
...
ls node_modules/express/lib/
head -50 node_modules/express/lib/server.js
```
...
node --print "require.resolve.paths('express')"
```
